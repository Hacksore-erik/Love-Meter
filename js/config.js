/* ============================================================
   ...
   Для локального режима оставьте CONFIG.SUPABASE.url и
   CONFIG.SUPABASE.anonKey пустыми.
   ============================================================ */
...
const CONFIG = {
  ...
  /* ==========================================================
     КЛЮЧИ LOCALSTORAGE
     ==========================================================
     Суффикс _v4. Меняйте только при полном сбросе.
     ========================================================== */
  STORAGE: {
    state: 'lovemeter_v4',
    ...
    coupleStatePeriod: 'lovemeter_couple_state_period'
  },

  /* ==========================================================
     ЗНАЧЕНИЯ ПО УМОЛЧАНИЮ
     ==========================================================
     names            — общее название пары (шапка профиля)
     myName           — моё имя (вижу только я)
     partnerName      — имя партнёра (подтягивается с сервера)
     hideMyVotes      — скрывать мои оценки от партнёра
     ========================================================== */
  DEFAULTS: {
    names: 'Моя пара',
    myName: 'Ты',
